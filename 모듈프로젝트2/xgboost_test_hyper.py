...
xTestName = "x_test.pkl"
yTestName = "y_test.pkl"
...
with open(pathFolder+xTestName,'rb') as f1:
    X_test = pickle.load(f1)

with open(pathFolder+yTestName,'rb') as f2:
...
'''
try 1: 
Best parameters found:  {'colsample_bytree': 0.6, 'gamma': 0, 'learning_rate': 0.2, 'max_depth': 3, 'n_estimators': 100, 'reg_alpha': 5, 'reg_lambda': 10, 'subsample': 0.6}
Accuracy: 77.60%
'''